...
class CustomExpandableOfflinePatientAdapter(
    private val context: Context, private val titleList: List<String>, private val dataList: HashMap<String, List<String>>
    ...
    override fun getChildView(
        ...
        displayObs.setText(expandedListText)
