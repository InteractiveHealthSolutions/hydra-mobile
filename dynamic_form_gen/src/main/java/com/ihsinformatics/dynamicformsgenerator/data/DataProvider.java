...
public class DataProvider {
    ...
    private void initInstance() {
        ...
        alphanumericAllCharacters13DigitWithHypen = new QuestionConfiguration(InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS, 13, 13, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890-", 7);
    ...
    private void initPatientCreation() {
        ...
        this.questions.add(new Question(true, patientCreationId, 6000, "", InputWidget.InputWidgetsType.WIDGETS_TYPE_IDENTIFIER, View.VISIBLE, Validation.CHECK_FOR_MRNO, identifier, ParamNames.PROJECT_IDENTIFIER, alphanumericAllCharacters13DigitWithHypen, Question.PAYLOAD_TYPE.IDENTIFIER));
